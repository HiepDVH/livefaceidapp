...
def calculate_metrics(original_img, enhanced_img):
    ...
    enhanced_img = enhanced_img.astype(np.float32) / 255
    ...
    # SSIM
    ssim_value, _ = ssim(original_img, enhanced_img, full=True, data_range=1)
...
if __name__ == '__main__':
    ...
    original_image_folder = '/home/hiepdvh/MIRNET/lol_dataset/eval15/low'
    enhanced_image_folder = '/home/hiepdvh/MIRNET/test'
