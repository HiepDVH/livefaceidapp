...
st.set_page_config(
    layout='wide', page_title='Live Webcam Face Recognition', page_icon=':sunglasses:'
)
...
gal_container.image(
    image=[identity.face for identity in gallery], caption=[identity.name for identity in gallery]
)
